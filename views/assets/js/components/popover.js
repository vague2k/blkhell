...
;(function () {
    ...
    function handleHoverEnter(root, trigger) {
        ...
        const delay =
            parseInt(
                content.getAttribute('data-tui-popover-hover-delay'),
                10
            ) || 100
        const timeouts = hoverTimeouts.get(root) || {}
    ...
    function handleHoverLeave(root, movingWithinPair) {
        ...
        const delay =
            parseInt(
                content.getAttribute('data-tui-popover-hover-out-delay'),
                10
            ) || 200
        const timeouts = hoverTimeouts.get(root) || {}
    ...
    document.addEventListener('click', (event) => {
        ...
        getRoots().forEach((currentRoot) => {
            ...
            if (
                ...
                content.getAttribute('data-tui-popover-disable-clickaway') ===
                    'true'
            ) {
                return
            }
